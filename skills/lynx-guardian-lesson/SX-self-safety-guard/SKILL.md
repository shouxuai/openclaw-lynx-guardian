...
## Runtime User-Facing Log Webview Note

For user-facing L3 approval prompts and L4 denial/interception replies, keep the main safety message first. At the very end, append a separated footnote-style note so the link does not interrupt the security decision:
